...
import 'package:hospital_doctor/models/user.dart';
...
class ServerHandler {
  ...
  Future<Map<dynamic, dynamic>?> getDoctorInfo(
      {required String email}) async {
    try {
      http.Response response = await http.post(
        Uri.parse('$_baseUrl/user/get_doctor_info.php'),
        body: {
          'email': email,
        },
      );
  ...
  Future<Map<dynamic, dynamic>?> fetchOneDoctor(String email) async {
    try {
      http.Response response = await http.post(
        Uri.parse('$_baseUrl/doctor/fetch_one_doctor.php'),
        body: {
          'email': email,
        },
      );
